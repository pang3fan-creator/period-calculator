        ...
        <div className="mt-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className={`flex min-h-[48px] items-center justify-center gap-2 rounded-xl ${
                mounted && theme === "light"
          ...
          <div className="space-y-1">
            {languages.map((lang) => (
              <button
                ...
                className="hover:bg-warmbeige-50 dark:hover:bg-dark-card flex min-h-[48px] w-full items-center gap-3 rounded-xl px-3"
              >
                {/* Radio indicator */}
                <span
