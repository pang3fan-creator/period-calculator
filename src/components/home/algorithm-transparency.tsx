...
/**
 * AlgorithmTransparency Section Component
 *
 * Displays a visual timeline showing how the period calculator works,
 * with formulas.
 *
 * Layout:
 ...
 */
export function AlgorithmTransparency() {
  const t = useTranslations("algorithmTransparency");
        ...
        <div className="hidden md:block">
          <div className="relative">
            ...
            <div className="relative grid grid-cols-4 gap-4">
              ...
              <TimelineNode
                icon="🥚"
                label={t("timeline.ovulation")}
                formula={t("formulas.ovulation")}
                position="middle"
              />

              {/* Node 3: Fertile Window */}
              <TimelineNode
                icon="🎯"
