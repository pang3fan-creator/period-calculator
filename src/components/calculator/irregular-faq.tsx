...
/**
 * Irregular FAQ Section Component
 *
 * Displays frequently asked questions about irregular periods
 ...
 */
export function IrregularFAQ() {
  const t = useTranslations("irregularFaq");
