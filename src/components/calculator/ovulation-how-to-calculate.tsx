...
/**
 * OvulationHowToCalculate Section Component
 *
 * Displays a 4-step explanation of how the ovulation calculator works.
 ...
 */
export function OvulationHowToCalculate() {
  const t = useTranslations("ovulationHowToCalculate");
